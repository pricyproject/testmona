...
MAX_ROWS_PER_IMPORT = 5000  # Maximum rows per import file
MAX_ROWS_PER_EXPORT = 5000  # Maximum rows per export response
...
def sanitize_csv_field(value: Any) -> str:
    """Sanitize field value to prevent CSV/Excel formula injection."""
    if not value:
        return ''
...
def normalize_multiline_text(text: str) -> str:
    """Normalize text without losing CSV-exported line breaks."""
    if not text:
        return ""
